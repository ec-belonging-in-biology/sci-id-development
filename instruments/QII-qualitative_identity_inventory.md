...
<details>
    ...
    - Ancient Manipuri (Ancient Meitei) (Sino-Tibetan)
    - 'Are'are (Malayo-Polynesian)
    - 'Auhelawa (Malayo-Polynesian)
    - A'Tong (Tibeto-Burman)
    - Aari (Omotic)
    - Abanyom (Bantu)
    ...
    - Harauti (Indo-Aryan)
    - Harsusi (Semitic)
    - Haryanavi (Indo-Aryan) (a dialect of Hindi)
    - Harzani (Iranian)
    - Hausa (Afro-Asiatic)
    ...
    - Ifè (Volta–Congo)
    - Igbo or Ibo or Biafra (Volta–Niger)
    ...
    - Ishkashimi or Ishkashmi (Iranian)
    ...
    - Larestani (Iranian)
    - Latin (Latino-Faliscan) (liturgical language)
    - Latvian (Baltic)
    ...
    - Lombard (Romance)
    - Lotha (Tibeto-Burman)
    - Low German or Low Saxon (Germanic)
    ...
    - Lycian (Indo-European)
    - Lydian (Indo-European)
    - Macedonian (Slavic)
    - Magadhi (Indo-Aryan)
    ...
    - Meänkieli or Tornedalen Finnish (Uralic)
    ...
    - Nyoro (Bantu)
    - Nǀu (Khoisan)
    - Occitan or Provençal (Romance)
    - Ojibwe or Ojibwa or Chippewa (Algonquian)
    - Okinawan (Japonic)
    - Olonets Karelian or Liv or Livvi (Uralic)
    - Omagua (Tupian)
    - Ongota (Afro-Asiatic)
    - Odia (Indo-Aryan)
    - Ormuri (Iranian)
    ...
    - Saraiki or Seraiki or Siraiki Southern Punjabi (Indo-Aryan)
